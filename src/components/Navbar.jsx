    ...
    <div>
      ...
      >
        <nav
          ...
          } md:px-12 px-6 border-b border-[#DEDFE2] shadow-[0_35px_60px_-15px_#1026490F] md:items-center relative`}
        >
          ...
          <div className="ml-auto md:hidden md:relative absolute top-4 right-4 text-gray-500 cursor-pointer ">
